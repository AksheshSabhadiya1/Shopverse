...
export default function Returns(props) {
    ...
    return (
        <div className={`${propsValue.includes('returns') ? 'w-full bg-white p-6 rounded-lg shadow-md' : ''}`}>
            <h2 className="text-3xl font-bold mb-8 text-gray-800 border-b pb-2">Your Returns</h2>
