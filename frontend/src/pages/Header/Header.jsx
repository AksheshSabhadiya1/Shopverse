            ...
            <div className="flex flex-wrap bg-black text-white justify-center py-0.5 items-center text-center">
                <p className="font-light sm:text-base mb-2 sm:mb-0 max-w-[60%] sm:max-w-full">
                    ...
                    <Link to="#" className="flex-shrink-0">
                        <span className="ms-2 border-b font-bold hover:text-[#DB4444] transition-all">Shop Now</span>
                    </Link>
                </p>
                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        </Link>
                        {
                            ...
                            <div className="hidden space-x-5 md:flex lg:flex justify-center items-center">
                                ...
                                </Link>
                                {
                                    ...
                                    > <User />
                                    </button> : <div> <NavLink to="/signup" className={({ isActive }) => `${isActive ? "text-orange-700" : "text-gray-700"} hover:text-orange-700`}>
                                        <span className="mb-2 font-semibold">Signup</span>
                                    </NavLink> |&nbsp;
                                        <NavLink to="/signin" className={({ isActive }) => `${isActive ? "text-orange-700" : "text-gray-700"} hover:text-orange-700`}>
                    ...
                    {menuOpen && (
                        <div className="lg:hidden flex flex-col bg-white py-4 space-y-3 justify-center items-center text-center">
                            ...
                            <NavLink to="/signup" className="text-gray-700 hover:text-orange-700" >Sign Up</NavLink>
                            {
                                    currentUser.length > 0 ? <button
                                        onClick={() => setUserDropDown(!userDropDown)}
                                        className={`flex items-center justify-center ${userDropDown ? 'w-8 h-8 text-white bg-red-500 rounded-full' : 'w-8 h-8'}`}
                                    > <User />
                                    </button> : <div> <NavLink to="/signup" onClick={() => setMenuOpen(false)} className={({ isActive }) => `${isActive ? "text-orange-700" : "text-gray-700"} hover:text-orange-700`}>
                                        <span className="mb-2 font-semibold">Signup</span>
                                    </NavLink> |&nbsp;
                                        <NavLink to="/signin" onClick={() => setMenuOpen(false)} className={({ isActive }) => `${isActive ? "text-orange-700" : "text-gray-700"} hover:text-orange-700`}>
                                            <span className="mb-2 font-semibold">Signin</span>
                                        </NavLink> </div>
                                }
                        </div>
