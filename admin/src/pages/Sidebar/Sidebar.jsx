...
export default function Sidebar() {
    ...
    return (
        <div className="h-full w-64 bg-gradient-to-br from-black via-gray-800 to-black text-white fixed left-0 top-0 flex flex-col p-4 shadow-lg overflow-y-auto">
                ...
                <div className="relative dropdown-container2">
                    ...
                    >
                        ...
                        <img
                            src="/icons/arrow-down-white.png"
                            alt="Dropdown"
                            className={`w-4 h-4 transform transition-transform duration-300 ${contactDropDown ? "rotate-180" : ""}`}
                        />
                    </button>
